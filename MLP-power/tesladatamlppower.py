...
class TeslaDatasetMlpPower(Dataset):
    def __init__(self, pData = 'tesla_driving_temp_data.csv',ID = -1, normalize = 1, device = "cuda:0", data = "train"):
        """
        ...
        # Compute temperature change between current and next time step and add it as an additional column to dataset
        df0['deltaTemp'] = df0['battery_temperature'].diff(periods=-1)*(-1)
        #Interpolate missing deltaTemp
        ...
        # function for finding indices of transition points between drives
        ...
        # find indices of transition points between drives       
        ...
        # function for calculating the central differences
        ...
        df_x = df0[["battery_temperature","acc_fwd_diff", "battery_level", "outside_temp"]]
